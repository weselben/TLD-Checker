...
<head>
    ...
    <meta name="description" content="Checke Top Level Domains (TLD's) auf deren Verfügbarkeit!">
    ...
    <meta name="page-type" content="Liste">
...
<div class="row">
    ...
    <div id="result" class="col s12">
        ...
        <div class="col s6">
            <table>
                <thead>
                    <th id="na">Nicht Verf&uuml;gbar</th>
                </thead>
                <tbody>
                    <td>
    ...
    <br><br><br>
    <div class="container">
        <p id="nodname">Bitte gib einen Domainnamen ein!</p>
    </div>
    <style>.page-footer{ position: fixed; left: 0; bottom: 0; width: 100%;}</style>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js"></script>
</body>';
        }
    } else {
        echo '<style>.page-footer{ position: fixed; left: 0; bottom: 0; width: 100%;}</style>';
    }
    ?>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js"></script>
</body>
