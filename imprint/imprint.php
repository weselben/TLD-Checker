...
<div class="container">
    <div class="rows">
        <h1>TLD-Checker - Legal Disclosure</h1>
        Information in accordance with Section 5 TMG
        <br><br>
        <h2>Contact Information</h2>
        E-Mail: <a href="mailto:bengottwaldi04+tld-checker@gmail.com">bengottwaldi04+tld-checker@gmail.com</a><br>Internet address: <a href="https://tld-checker.net/" target="_blank">https://tld-checker.net/</a><br><br>
        <h2>Disclaimer</h2>
